...
class LiveLayerStatus(FrozenStrictModel):
    ...
    @model_validator(mode="after")
    def availability_fields_are_consistent(self) -> LiveLayerStatus:
        observations = (
...
class MapViewport(FrozenStrictModel):
    ...
    @model_validator(mode="after")
    def ordered_bounds(self) -> MapViewport:
...
class LivePagination(FrozenStrictModel):
    ...
    @model_validator(mode="after")
    def derived_fields_are_consistent(self) -> LivePagination:
...
class NearMeResponse(FrozenStrictModel):
    ...
    @model_validator(mode="after")
    def page_contract_is_consistent(self) -> NearMeResponse:
