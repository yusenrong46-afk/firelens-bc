...
from firelens.review_workspace.input_corpus import (
    read_governed_chunks as _read_governed_chunks,
    validate_governed_corpus_manifest as _validate_governed_corpus_manifest,
)
...
def import_retrieval_suite(
    ...
    chunks, corpus_identity, source_counts = _read_governed_chunks(corpus_path)
    manifest, manifest_identity = _read_json(corpus_manifest_path, "corpus_manifest")
    _validate_governed_corpus_manifest(
        manifest,
