...
Keep the deterministic authority boundary intact: models propose language; source contracts, validation, and humans decide. Production must require OpenRouter ZDR and must not persist questions, answers, deterministic query hashes, or precise locations.
