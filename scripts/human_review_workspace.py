...
except ModuleNotFoundError:  # Direct execution resolves sibling scripts without the namespace.
    from upgrade_benchmark import (  # type: ignore[no-redef]
        DEFAULT_SPEC,
        FRONTEND_MANUAL_REVIEW_PROTOCOL,
        _frontend_manual_review_protocol,
        _named_frontend_reviewer,
...
def _recipe(args: argparse.Namespace) -> tuple[str, ReviewInputRecipe]:
